...
replace github.com/open-telemetry/opentelemetry-collector-contrib/receiver/prometheusreceiver => ../opentelemetry-collector-contrib-TI/receiver/prometheusreceiver
